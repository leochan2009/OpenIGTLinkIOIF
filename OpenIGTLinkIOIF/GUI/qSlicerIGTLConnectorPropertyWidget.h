...
class Q_SLICER_QTMODULES_OPENIGTLINKIOIF_EXPORT qSlicerIGTLConnectorPropertyWidget : public QWidget
{
  Q_OBJECT
  QVTK_OBJECT
public:
...
public slots:
  ...
  void setMRMLIGTLConnectorNode(vtkIGTLIOConnector * connectorNode);

  /// Utility function that calls setMRMLIGTLConnectorNode(vtkIGTLIOConnector*)
