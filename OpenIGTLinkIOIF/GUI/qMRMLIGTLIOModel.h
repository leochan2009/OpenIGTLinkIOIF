...
// Logic includes
#include "Logic/vtkSlicerOpenIGTLinkIOIFLogic.h"
...
class Q_SLICER_QTMODULES_OPENIGTLINKIOIF_EXPORT qMRMLIGTLIOModel : public qMRMLSceneModel
{
  Q_OBJECT
 ...
 protected:
  ...
  virtual void updateIOTreeBranch(vtkIGTLIOConnector* node, QStandardItem* item, qMRMLIGTLIOModel::Direction dir);
