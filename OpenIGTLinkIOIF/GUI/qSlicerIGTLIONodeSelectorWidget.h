...
class Q_SLICER_QTMODULES_OPENIGTLINKIOIF_EXPORT qSlicerIGTLIONodeSelectorWidget : public QWidget
{
  Q_OBJECT
  QVTK_OBJECT
public:
...
public slots:
  ...
  /// Set the MRML node of interest
  void updateEnabledStatus(int type, vtkIGTLIOConnector* cnode, int dir, vtkMRMLNode* dnode);
